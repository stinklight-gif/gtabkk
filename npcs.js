...
export function updatePeds(dt) {
  ...
  for (let pedIdx = 0; pedIdx < G.peds.length; pedIdx++) {
    ...
    if (ped.btsSit || ped.sevenGuard || ped.mallGuard || ped.bankGuard || ped.soiDrink) {
