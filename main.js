...
async function init() {
  ...
  spawnMallGuard(scene);
  spawnBankGuard(scene);
  spawnBankQueue(scene);
  spawnGunClerk(scene);
  spawnStarterClerk(scene);
  spawnHomeAuntie(scene);
  spawnStationPorter(scene);
  spawnGarageMech(scene);
  spawnKlongDock(scene);
  spawnSengClerk(scene);
  spawnAirportCrew(scene);
  spawnAirportCargo(scene);
  spawnAirportTower(scene);
  spawnAirportTaxi(scene);
  spawnMallDirectory(scene);
  spawnMallFood(scene);
  spawnMallTech(scene);
  spawnMallPharm(scene);
  spawnMallRoma(scene);
  spawnMallWatch(scene);
  spawnMallManga(scene);
  spawnMallSushi(scene);
  spawnMallCafe(scene);
  spawnMallThreads(scene);
  spawnMallSeven(scene);
  spawnMallArcade(scene);
  spawnGymBag(scene);
  spawnSevenAtm(scene);
  ...
  spawnWatLotus(scene);
  spawnWatAmulet(scene);
  spawnWatCats(scene);
  spawnShrineKeep(scene);
  spawnLottery(scene);
  spawnKanomKrok(scene);
  spawnSquidGrill(scene);
  spawnYaoGold(scene);
  spawnYaoDuck(scene);
  spawnYaoFortune(scene);
  buildClusterAnchors();
...
export function loop() {
  ...
  if (G.state === 'playing') {
    ...
    updateBankQueue(dt);
    updateGunClerk(dt);
    updateStarterClerk(dt);
    updateHomeAuntie(dt);
    updateStationPorter(dt);
    updateGarageMech(dt);
    updateKlongDock(dt);
    updateSengClerk(dt);
    updateAirportCrew(dt);
    updateAirportCargo(dt);
    updateAirportTower(dt);
    updateAirportTaxi(dt);
    updateWindsock(dt);
    updateRunwayLights(dt);
    updateTowerBeacon(dt);
