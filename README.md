...
- City geometry is still procedural (baked boxes + a Thai-script canvas atlas).
  ...
  jets you can taxi) — not a 4 km GIS airport. The BTS is a two-stop commute on
  the existing track. Yaowarat densifies at night. Longtails can be taken from
  NPC drivers. One 7-Eleven is a walk-in interior.
