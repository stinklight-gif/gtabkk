...
| 14 | Combat | Muay Thai jab/cross/kick (animated arm/leg swings), pistol + full-auto SMG fire (raycast hit + tracer sphere + muzzle flash + camera shake), reload. Pistol on first cop kill; SMG drops from a destroyed 3★ Fortuner or can be bought at the gun shop. |
